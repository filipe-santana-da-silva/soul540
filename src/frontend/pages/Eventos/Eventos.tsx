...
<div className={styles.controls}>
      ...
      {filtered.length === 0 ? (
        ...
        <div className={styles.grid}>
          {filtered.map((ev) => (
            <div key={ev.id} className={styles.card} onClick={() => setViewingEvent(ev)}>
              ...
              <div className={styles.cardBody}>
                ...
                <div className={styles.cardRow}>
                  ...
                  {ev.guestCount} convidados
                  {ev.staffCount ? ` · ${ev.staffCount} funcionarios` : ''}
                </div>
                <div className={styles.cardRow}>
              ...
              <div className={styles.cardActions}>
                <button className={styles.btnEdit} onClick={(e) => { e.stopPropagation(); openEdit(ev); }}>Editar</button>
                <button className={styles.btnDelete} onClick={(e) => { e.stopPropagation(); handleDelete(ev.id); }}>Excluir</button>
              </div>
            </div>
          ))}
        </div>
              ...
              <div className={styles.formSection}>
                ...
                <div className={styles.formGrid2}>
                  <div className={styles.formGroup}>
                    ...
                    <input className={styles.input} type="number" value={form.budget} onChange={(e) => setForm({ ...form, budget: e.target.value })} placeholder="0" />
                  </div>
                  <div className={styles.formGroup}>
